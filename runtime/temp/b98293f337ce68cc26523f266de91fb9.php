<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:61:"/data/demo/public/../application/admin/view/addon/config.html";i:1514864175;s:63:"/data/demo/public/../application/admin/view/layout/default.html";i:1514864177;s:60:"/data/demo/public/../application/admin/view/common/meta.html";i:1514864177;s:62:"/data/demo/public/../application/admin/view/common/script.html";i:1514864177;}*/ ?>
<!DOCTYPE html>
                        ...
                        <div class="col-sm-8 col-xs-12">
                            ...
                            <dl class="fieldlist" rel="<?php echo count($item['value']); ?>" data-name="row[<?php echo $item['name']; ?>]">
                                ...
                                <dd class="form-inline">
                                    ...
                                    <input type="text" name="row[<?php echo $item['name']; ?>][value][<?php echo $key; ?>]" class="form-control" value="<?php echo $vo; ?>" size="30" />
