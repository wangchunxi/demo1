<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:63:"/data/demo/public/../application/admin/view/auth/rule/edit.html";i:1514864176;s:63:"/data/demo/public/../application/admin/view/layout/default.html";i:1514864177;s:60:"/data/demo/public/../application/admin/view/common/meta.html";i:1514864177;s:62:"/data/demo/public/../application/admin/view/auth/rule/tpl.html";i:1514864176;s:62:"/data/demo/public/../application/admin/view/common/script.html";i:1514864177;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo build_select('row[pid]', $ruledata, $row['pid'], ['class'=>'form-control selectpicker', 'required'=>'']); ?>
        </div>
    </div>
    <div class="form-group">
        <label for="name" class="control-label col-xs-12 col-sm-2"><?php echo __('Name'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input type="text" class="form-control" id="name" name="row[name]" placeholder="<?php echo __('Controller/Action'); ?>" value="<?php echo $row['name']; ?>" data-rule="required" />
        </div>
    </div>
    <div class="form-group">
