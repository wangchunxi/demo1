<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:77:"/data/demo/public/../application/admin/view/example/bootstraptable/index.html";i:1514865208;s:63:"/data/demo/public/../application/admin/view/layout/default.html";i:1514864177;s:60:"/data/demo/public/../application/admin/view/common/meta.html";i:1514864177;s:62:"/data/demo/public/../application/admin/view/common/script.html";i:1514864177;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="form-inline" data-toggle="cxselect" data-selects="group,admin">
                ...
                <select class="admin form-control" name="admin" data-url="example/bootstraptable/cxselect?type=admin" data-query-name="group_id"></select>
                <input type="hidden" class="form-control operate" name="admin_id" value="" />
            </div>
        </div>
    </div>
</script>
